<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Status.aspx" MasterPageFile="~/MasterPage.Master" Inherits="MojBilet.Secret.Selectseat" %>
   ...
   <table align="center">
        <tr align="left">
            <td align="left" class="style1" >
               <strong> <asp:Label ID="lblheat" runat="server" Text="Проверете Статус" Font-Size= "X-Large"  
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="63%" align="left" height="27">
                                                            <asp:DropDownList CssClass="form" ID="Source" runat="server">
                                                                <asp:ListItem Text="Битола" Value="Битола"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <asp:UpdatePanel ID="up2" runat="server"><ContentTemplate>
                                                            <div id="txtHint">
                                                                <asp:DropDownList CssClass="form" style="width: 130px" ID="Destination" runat="server"
                                                                    AutoPostBack="True" OnSelectedIndexChanged="Destination_SelectedIndexChanged">
                                                                    <asp:ListItem Text="--Изберете--" Value="--Изберете--"></asp:ListItem>
                                                                            <asp:ListItem Text="Скопје" Value="Скопје"></asp:ListItem>
                                                                            <asp:ListItem Text="Прилеп" Value="Прилеп"></asp:ListItem>
                                                                            <asp:ListItem Text="Велес" Value="Велес"></asp:ListItem>
                                                                            <asp:ListItem Text="Охрид" Value="Охрид"></asp:ListItem>
                                                                            <asp:ListItem Text="Д.Хисар" Value="Д.Хисар"></asp:ListItem>
                                                                            <asp:ListItem Text="Кавадарци" Value="Кавадарци"></asp:ListItem>
                                                                            <asp:ListItem Text="Кичево" Value="Кичево"></asp:ListItem>
                                                                            <asp:ListItem Text="Тополчани" Value="Тополчани"></asp:ListItem>
                                                                            <asp:ListItem Text="Неготино" Value="Неготино"></asp:ListItem>
                                                                            <asp:ListItem Text="Штип" Value="Штип"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
