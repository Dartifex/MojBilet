<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Selectseat.aspx.cs" MasterPageFile="~/MasterPage.Master" Inherits="MojBilet.Selectseat.aspx, App_Web_jaxgazb3" %> 
<!--Inherits da se smeni-->
...
<asp:Content ID="Content2" ContentPlaceHolderID="content1" runat="Server">
    <table align="center">
        <tr>       
            <td>
               <strong> <asp:Label ID="lblheat" runat="server" Text="Резервирајте Билет" Font-Size= "X-Large"  
