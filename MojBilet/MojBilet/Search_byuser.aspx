<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master"  Inherits="Search_user, App_Web_2ted6jil" %>
                                            ...
                                            <tbody>                                                
                                                <tr>
                                                    <td colspan="2" height="25">
                                                        <strong>Внесете го PNR бројот:</strong>
                                                    </td>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tbody>
                                        <tr>
                                            <td class="logo">
                                                <!-- logo here-->
                                                <img alt="bus" src="Images/logo1.gif"/>
                                                <!-- end of logo-->
                                            </td>
                                        </tr>
                                    </tbody>
                                                        ...
                                                        <tbody  align="left"  >
                                                            <tr >
                                                                ...
                                                                <td style="margin-left:15px;width:100px">
                                                                    <strong>Име на компанија</strong></td>
                                                                <td>:</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <strong>Време</strong></td>
                                                                    <td>:</td>
                                                                    <td><asp:Literal ID="littime" runat="server" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left" height="25">
                                                                        <strong> Број на Седиште </strong>
                                                                    </td>
                                                                    <td align="left" class="style3">
                                                                        :
                                                                    </td>
