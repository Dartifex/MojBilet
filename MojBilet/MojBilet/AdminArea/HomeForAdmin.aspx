<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="HomeForAdmin.aspx.cs" Inherits="MojBilet.AdminArea.HomeForAdmin" %>
                                ...
                                <div style="float: left; width: 321px; height: 157px;">
                                    <table cellspacing="0" cellpadding="0" border="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td height="25" style="font-size:medium;color:Black  ">
                                                    <strong>Број на Компанија </strong>
                                                </td>
                                                <td>
                                                    :
                                                </td>
